...
CASES = [
    {
        ...
        "before": {"time":"日均3.5h人工盘点","cost":"年囤货损失$4,200","people":"1人","error":"漏单率12%"},
        "after": {"time":"日均10min自动监控","cost":"年囤货损失$680（降84%）","people":"0.2人","error":"漏单率0%"},
        "region": "北美",
    ...
    },
    {
        ...
        "before": {"time":"每天2h手算定价","cost":"平均利润率32%","people":"1人","error":"经常漏算平台费"},
        "after": {"time":"一键生成定价方案","cost":"平均利润率51%（+19%）","people":"0人","error":"0误差"},
        "region": "日韩",
    ...
    },
    {
        ...
        "before": {"time":"选品决策1周","cost":"拍脑袋选品翻车率40%","people":"2人","error":"竞品分析靠手动"},
        "after": {"time":"Agent 跑完全流程","cost":"翻车率降至8%","people":"0人","error":"实时竞品数据"},
        "region": "北美",
